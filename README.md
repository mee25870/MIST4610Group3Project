...
5. Query 5 answers the question "Which drones require the most maintence?". This can help a manager identify which drones may need to be taken out of the field or are not worth saving. It can also provide insights into which models breakdown or require heavy maintence, which can change furutre purchasing decisions when replenishing or expanding the drone fleet. 
